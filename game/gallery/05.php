...
<div id="center">
    <div id="wrapper">
        <div id="header">
            ...
            <div class="nav">
                <ul>
                    ...
                    <li>
                        <a href="/jp/game/gallery/05.php" class="button-right"><span>日本語</span></a>
                    </li>
                </ul>
            </div>
            <div class="subnav gapTopHalf">
                <ul>
                    ...
                    <li>
                        <a href="/game/gallery/" class="button-sub"><span class="aqua">GALLERY</span></a>
                    </li>
                    <li>
                        <a href="/game/trailer/" class="button-sub"><span>TRAILER</span></a>
                    </li>
                    <li>
                        <a href="/game/code/" class="button-sub"><span>CODE</span></a>
                    </li>
                    <li>
        ...
        <div id="content" class="gapTopHalf">
            <div class="field3">
                <img src="/img/screenshot-05.png" alt="Nikki and the Robots" />
                <a href="/game/gallery/06.php" class="button-single gapTopFull" style="float:right"><span>NEXT IMAGE</span></a>
                <a href="/game/gallery/04.php" class="button-single gapTopFull" style="float:left"><span>PREVIOUS IMAGE</span></a>
            </div>
        </div>
        <div id="footer">
