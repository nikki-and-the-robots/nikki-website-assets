...
<div id="center">
    <div id="wrapper">
        <div id="header">
            ...
            <div class="nav">
                <ul>
                    ...
                    <li>
                        <a href="/jp/game/gallery/" class="button-right"><span>日本語</span></a>
                    </li>
                </ul>
            </div>
        ...
        <div id="content" class="gapTopHalf">
            <div class="field3">
                <img src="/img/screenshot-01.png" alt="Nikki and the Robots" />
                <a href="/game/gallery/02.php" class="button-single gapTopFull" style="float:right"><span>NEXT IMAGE</span></a>
                <a href="/game/gallery/06.php" class="button-single gapTopFull" style="float:left"><span>PREVIOUS IMAGE</span></a>
            </div>
        </div>
        <div id="footer">
