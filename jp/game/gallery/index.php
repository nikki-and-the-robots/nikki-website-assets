...
<div id="center">
    <div id="wrapper">
        <div id="header">
            ...
            <div class="nav">
                <ul>
                    ...
                    <li>
                        <a href="/game/gallery/" class="button-right"><span lang="en">EN / DE</span></a>
                    </li>
                </ul>
            </div>
        ...
        <div id="jp-content" class="gapTopHalf">
            <div class="field3">
                <img src="/img/screenshot-01.png" alt="Test" />
                <a href="/jp/game/gallery/06.php" class="button-single gapTopFull" style="float:left"><span>マエ</span></a>
                <a href="/jp/game/gallery/02.php" class="button-single gapTopFull" style="float:right"><span>ツギ</span></a>
            </div>
        </div>
